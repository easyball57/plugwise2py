...
app.controller("pw2pyCtrl", function pw2pyCtrl($scope, $http, WS){
  ...
  //Modification jeedom
	//plugwise/000D6F0001Annnnn/switch {"mac":"","cmd":"switch","val":"on"}
  var topic = "plugwise/cmd/"+circle.mac+"/switch"
  ...
  //var topic = "plugwise2py/cmd/schedule/"+circle.mac
	//Modification jeedom
	//plugwise/000D6F0001Annnnn/schedule {"mac":"","cmd":"schedule","val":"on"}
  var topic = "plugwise/cmd/"+circle.mac+"/schedule"
